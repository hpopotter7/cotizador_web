<html lang="en"><head>
    ...
    <title>Roles de usuario - Cotizador Web</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor mb-0 mt-0">Roles de usuario</h3>
                        <ol class="breadcrumb">
					 ...
					 <div class="col-md-6 col-4 align-self-center">
                        ...
                        <button class="btn float-right  btn-success" data-toggle="modal" data-target="#permisos_modal"><i class="mdi mdi-plus-circle"></i> <span class="hidden-sm-down">Nuevo</span></button>
	  ...
	  <table class="table table-hover table-nomargin">
		...
		<tbody>
			...
			<td><input type="checkbox" name="del_1" value="1" class="ck2"></td>
				...
				<tr>
			<td>
				Cotizaciones				<input type="hidden" name="permisos_2" value="Cotizaciones">
			</td>
			...
			<td><input type="checkbox" name="del_2" value="1" class="ck2"></td>
				...
				<tr>
			<td>
				Clientes				<input type="hidden" name="permisos_3" value="Clientes">
			</td>
			...
			<td><input type="checkbox" name="del_3" value="1" class="ck2"></td>
				...
				<tr>
			<td>
				Productos				<input type="hidden" name="permisos_4" value="Productos">
			</td>
			...
			<td><input type="checkbox" name="del_4" value="1" class="ck2"></td>
				...
				<tr>
			<td>
				Proveedores				<input type="hidden" name="permisos_5" value="Fabricantes">
			</td>
			...
			<td><input type="checkbox" name="del_5" value="1" class="ck2"></td>
				...
				<tr>
			<td>
				Monedas				<input type="hidden" name="permisos_6" value="Monedas">
			</td>
			...
			<td><input type="checkbox" name="del_6" value="1" class="ck2"></td>
				...
				<tr>
			<td>
				Usuarios				<input type="hidden" name="permisos_7" value="Usuarios">
			</td>
			...
			<td><input type="checkbox" name="del_8" value="1" class="ck2"></td>
				...
				<tr>
			<td>
				Configuracion				<input type="hidden" name="permisos_9" value="Configuracion">
			</td>
...
</form> <form class="form-horizontal" method="post" id="editar_permisos" name="editar_permisos">
<!-- Modal -->
<div class="modal fade" id="permisos_edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" id="actualizar_datos" class="btn btn-primary">Actualizar datos</button>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Buscar roles de usuario</h4>
                                  <div class="row">
								...
								<div class="row">
									<div id="resultados_ajax" style="width:100%"></div><!-- Carga los datos ajax -->
									<div id="resultados" class="col-sm-12 " style="width:100%"></div><!-- Carga los datos ajax -->
							...
							<td class="text-right">
                                ...
                                <button type="button" class="btn btn-light dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                 ...
                                 <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 37px, 0px); top: 0px; left: 0px; will-change: transform;">
																		<a class="dropdown-item" href="javascript:void(0)" data-toggle="modal" data-target="#permisos_edit" onclick="editar('1');"><i class="fa fa-edit"></i> Editar </a>
																	</div>
						...
						<tr>
							...
							<td class="text-right">
                                ...
                                <button type="button" class="btn btn-light dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                 ...
                                 <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 37px, 0px); top: 0px; left: 0px; will-change: transform;">
																		<a class="dropdown-item" href="javascript:void(0)" data-toggle="modal" data-target="#permisos_edit" onclick="editar('2');"><i class="fa fa-edit"></i> Editar </a>
																	</div>
	...
	<!--Sweetalert plugin -->
	<script src="assets/plugins/sweetalert/sweetalert.min.js"></script>	<script type="text/javascript" src="assets/js/permisos.js"></script>
