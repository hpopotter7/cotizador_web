		  ...
		  <div class="modal-body">
			<form class="form-horizontal" method="post" id="editar_cliente" name="editar_cliente">
               ...
               <div class="row justify-content-end">
                    <div class="col-md-3">
                        <label class="radio-inline" for="mod_cliente">
                            <input type="radio" name="prospectoRadio" id="mod_cliente" value="0">
                            Cliente
                        </label>
                    </div>
                    <div class="col-md-3">
                        <label class="radio-inline" for="mod_prospecto">
                            <input type="radio" name="prospectoRadio" id="mod_prospecto" value="1">
                            Prospecto
                        </label>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="actualizar_datos">Actualizar datos</button>
            </div>
		  </form>
		</div>
	  </div>
