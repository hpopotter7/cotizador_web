<?php
    ...
    $prospecto=$_POST['prospectoRadio'];
    ...
    if (mysqli_connect_errno()) {
        ...
        $sql="update clientes set Razon_Social='".$razon_social."', RFC='".$rfc."', Giro='".$giro."', Direccion='".$direccion."', Contacto='".$contacto."', Correo_contacto='".$correo_contacto."', Telefono='".$telefono."', Prospecto=".$prospecto." where id_cliente=".$id_cliente;
        if ($con->query($sql)) {
