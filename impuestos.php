<html lang="en"><head>
    ...
    <title>Impuestos - Cotizador Web</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor mb-0 mt-0">Impuestos</h3>
                        <ol class="breadcrumb">
...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
        ...
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
       	<button type="submit" class="btn btn-primary" id="actualizar_datos">Actualizar datos</button>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Buscar impuestos</h4>
                                  <div class="row">
					...
					<tr>
						...
						<td><span class="label label-danger">Inactivo</span></td>
										...
										<td class="text-right">
											...
											<a href="#" class="btn btn-info" title="Editar impuesto" data-toggle="modal" data-target="#myModal2" data-nombre="iva" data-estado="0" data-valor="16.00" data-id="1"><i class="fa fa-edit"></i></a> 
					...
					<tr>
						...
						<td><span class="label label-danger">Inactivo</span></td>
										...
										<td class="text-right">
											...
											<a href="#" class="btn btn-info" title="Editar impuesto" data-toggle="modal" data-target="#myModal2" data-nombre="ITBIS" data-estado="0" data-valor="1.00" data-id="7"><i class="fa fa-edit"></i></a> 
					...
					<tr>
						...
						<td><span class="label label-success">Activo</span></td>
										...
										<td class="text-right">
											...
											<a href="#" class="btn btn-info" title="Editar impuesto" data-toggle="modal" data-target="#myModal2" data-nombre="IVA" data-estado="1" data-valor="12.00" data-id="8"><i class="fa fa-edit"></i></a> 
					...
					<tr>
						...
						<td><span class="label label-danger">Inactivo</span></td>
										...
										<td class="text-right">
											...
											<a href="#" class="btn btn-info" title="Editar impuesto" data-toggle="modal" data-target="#myModal2" data-nombre="IFV" data-estado="0" data-valor="12.00" data-id="9"><i class="fa fa-edit"></i></a> 
					...
					<tr>
						...
						<td><span class="label label-danger">Inactivo</span></td>
										...
										<td class="text-right">
											...
											<a href="#" class="btn btn-info" title="Editar impuesto" data-toggle="modal" data-target="#myModal2" data-nombre="itbms" data-estado="0" data-valor="7.00" data-id="10"><i class="fa fa-edit"></i></a> 
					...
					<tr>
						...
						<td><span class="label label-success">Activo</span></td>
										...
										<td class="text-right">
											...
											<a href="#" class="btn btn-info" title="Editar impuesto" data-toggle="modal" data-target="#myModal2" data-nombre="IVA" data-estado="1" data-valor="19.00" data-id="11"><i class="fa fa-edit"></i></a> 
					...
					<tr>
						...
						<td><span class="label label-danger">Inactivo</span></td>
										...
										<td class="text-right">
											...
											<a href="#" class="btn btn-info" title="Editar impuesto" data-toggle="modal" data-target="#myModal2" data-nombre="iva" data-estado="0" data-valor="1.00" data-id="12"><i class="fa fa-edit"></i></a> 
					...
					<tr>
						...
						<td><span class="label label-success">Activo</span></td>
										...
										<td class="text-right">
											...
											<a href="#" class="btn btn-info" title="Editar impuesto" data-toggle="modal" data-target="#myModal2" data-nombre="IGV" data-estado="1" data-valor="18.00" data-id="13"><i class="fa fa-edit"></i></a> 
					...
					<tr>
						...
						<td><span class="label label-success">Activo</span></td>
										...
										<td class="text-right">
											...
											<a href="#" class="btn btn-info" title="Editar impuesto" data-toggle="modal" data-target="#myModal2" data-nombre="ninguno" data-estado="1" data-valor="0.00" data-id="14"><i class="fa fa-edit"></i></a> 
	...
	<!--Sweetalert plugin -->
	<script src="assets/plugins/sweetalert/sweetalert.min.js"></script>	<script type="text/javascript" src="assets/js/impuestos.js"></script>
