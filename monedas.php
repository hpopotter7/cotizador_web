...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			 ...
			 <div class="row">
			  ...
			  <div class="col-sm-4">
				<label for="simbolo" class=" control-label">Símbolo</label>
				  ...
				  <input type="text" class="form-control" id="simbolo" name="simbolo" placeholder="Símbolo" required="" maxlength="3">
  ...
  <script type="text/javascript" src="assets/js/monedas.js"></script>
