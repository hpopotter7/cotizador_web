	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			...
			<div class="row">
				<div class="col-sm-12">
					<label for="firstname2" class="control-label">username</label>
					<input type="text" class="form-control" id="mod_username" name="mod_username" placeholder="Username" required="">
					<input type="hidden" id="mod_id" name="mod_id">
				</div>
			  </div>
			  <div class="row">
			  <div class="col-sm-12">
				<label for="lastname2" class="control-label">Nombre</label>
			  ...
			  <div class="row">
				<div class="col-sm-12">
				  ...
				  <select class="form-control" name="mod_grupo" id="mod_grupo">
													<option value="admin">Administrador</option>	
													<option value="usuario">Usuario</option>	
												</select>
				</div>
