                    ...
                    <div class="col-md-12">
                        <div class="card">
							...
							<div class="col-xs-6 col-md-4 text-center">
								...
								<hr>
								<input type="radio" name="id_plantilla" id="id_plantilla" value="4" checked=""> Color Sea								<hr>
							  </div>
							...
							<div class="col-xs-6 col-md-4 text-center">
								...
								<hr>
								<input type="radio" name="id_plantilla" id="id_plantilla" value="6"> Servicios								<hr>
							  </div>
